...
""" This module allow to launch a new game with the construction
    of a map and all its components.
    After creating an instance of Game, the new game is ready
    to be played."""


class Game:
    """ Define the game itself. It begins with the creation of
